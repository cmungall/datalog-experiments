...
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"name","path"},{"operation","output"},{"output-dir","."},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"auxArity\": 0, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"auxArity\": 0, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"fact-dir","."},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"auxArity\": 0, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"auxArity\": 0, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
SignalHandler::instance()->setMsg(R"_(path(x,y) :- 
   edge(x,y).
in file /Users/cjm/repos/souffle-test/example.dl [7:1-7:26])_");
if(!(rel_3_edge->empty())) {
[&](){
...
SignalHandler::instance()->setMsg(R"_(path(x,y) :- 
   path(x,z),
   edge(z,y).
in file /Users/cjm/repos/souffle-test/example.dl [8:1-8:38])_");
...
extern "C" {
factory_Sf_example __factory_Sf_example_instance;
}
}
#else
}
